...
CREATE TABLE [dbo].[Question] (
    ...
    [OptionsAlignment] VARCHAR (50)  NOT NULL,
    PRIMARY KEY CLUSTERED ([Id] ASC)
);
...
CREATE TABLE [dbo].[Survey] (
    ...
    CONSTRAINT [PK__Survey__3214EC076FDE4AC7] PRIMARY KEY CLUSTERED ([Id] ASC) ON [PRIMARY]
) ON [PRIMARY];
...
GO
PRINT N'Creating [dbo].[UserShareSurvey]...';
...
CREATE TABLE [dbo].[UserShareSurvey] (
    ...
    [SurveyId] INT            NOT NULL,
    PRIMARY KEY CLUSTERED ([Id] ASC),
    CONSTRAINT [UC_UserSurvey] UNIQUE NONCLUSTERED ([UserId] ASC, [SurveyId] ASC)
);
...
GO
PRINT N'Creating [dbo].[Proc_GetAllStudents]...';
